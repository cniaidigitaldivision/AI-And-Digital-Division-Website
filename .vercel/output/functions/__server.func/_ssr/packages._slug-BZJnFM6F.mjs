...
import { a as GoldRule, i as Footer, s as Navbar } from "./Contact-DWLIruNB.mjs";
import { i as Route$4, s as PACKAGES } from "./router-CoCz_VNl.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/packages._slug-BZJnFM6F.js
...
function PackageRoutePage() {
	const { pkg } = Route$4.useLoaderData();
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
