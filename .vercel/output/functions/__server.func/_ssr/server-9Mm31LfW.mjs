...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/server-9Mm31LfW.js
var server_9Mm31LfW_exports = /* @__PURE__ */ __exportAll({
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-D1rcoRWp.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-a2RV35hi.mjs").then((n) => n.t),
...
//#endregion
export { getServerFnById as a, createServerEntry, server_default as default, createServerFn as i, createMiddleware as n, TSS_SERVER_FUNCTION as r, server_9Mm31LfW_exports as t };
