...
function SectionHeading({ children }: { children: React.ReactNode }) {
  return (
    ...
    >
      <h3 className="font-display text-3xl md:text-4xl font-semibold text-white">{children}</h3>
      <motion.div
        initial={{ scaleX: 0 }}
      ...
      <main className="flex-1 flex flex-col w-full">
        ...
        >
          ...
          <div className="max-w-5xl mx-auto w-full text-center relative z-10">
            ...
            >
              Building smarter brands, scalable systems, and sustainable growth across Pakistan and
              Saudi Arabia.
            </motion.p>
          </div>
        ...
        <div className="max-w-5xl mx-auto w-full px-6 space-y-32 md:space-y-48 pb-32">
          ...
          <section className="relative">
            <div className="absolute -left-[10%] top-0 text-[15rem] font-display font-bold text-white/5 pointer-events-none select-none z-0">
              01
            </div>
            <div className="grid md:grid-cols-12 gap-12 items-start relative z-10">
              ...
              <div className="md:col-span-7 space-y-6 text-muted-foreground leading-relaxed text-lg md:text-xl font-light">
                <p>
                  <RevealText text="CNI AI & Digital Division is the modern growth and technology arm of Crescent Nova International (SMC-Private) Limited. We are not just a service vendor; we believe that modern businesses need a comprehensive growth engine to truly thrive in today's landscape." />
                </p>
                <p>
                  <RevealText
          ...
          <section className="relative">
            <div className="absolute -right-[10%] top-0 text-[15rem] font-display font-bold text-white/5 pointer-events-none select-none z-0">
              02
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 relative z-10">
              ...
              >
                ...
                <p className="text-muted-foreground leading-relaxed text-lg relative z-10">
                  To be the most trusted and innovative business growth and digital transformation
                  partner in Pakistan and Saudi Arabia. This means we are dedicated to helping
                  organizations grow smarter, lead their industries into the future, and achieve
              ...
              >
                ...
                <p className="text-muted-foreground leading-relaxed text-lg relative z-10">
                  To deliver innovative branding, digital growth, automation, custom software, and
                  AI solutions. We focus on driving efficiency, enhancing the customer experience,
                  and creating measurable business value that you can actually see in your results.
                </p>
              </motion.div>
            </div>
          </section>
          ...
          {/* 4. WHAT WE VALUE */}
          <section className="relative">
            <div className="absolute left-[30%] top-[-5%] text-[15rem] font-display font-bold text-white/5 pointer-events-none select-none z-0">
              03
            </div>
          ...
          <section className="relative">
            <div className="absolute right-[20%] top-[-10%] text-[15rem] font-display font-bold text-white/5 pointer-events-none select-none z-0">
              04
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="space-y-6 text-muted-foreground leading-relaxed text-lg">
                <p>
                  We offer nine core service pillars: Branding & Identity, Printing & Corporate
                  Collateral, Website Development & Ecommerce, SEO & AI Visibility, Digital
                  Marketing & Paid Media, Content & Influencers, CRM & WhatsApp Automation, Custom
                  Software & ERPs, and AI Automations & Dashboards.
                </p>
                <p>
                  These are not isolated offerings. They work together to form one integrated
                  ecosystem. From defining your brand to automating your back-office, we cover the
                  entire business journey to ensure every piece of your operation is aligned for
                  growth.
                </p>
                <p>
                  For example, we might start by building your brand identity, then create a
                  beautiful website to showcase it, drive traffic through SEO and paid ads, capture
                  incoming leads via WhatsApp automation, and finally, help you analyze everything
                  with real-time AI-powered dashboards.
                </p>
              </div>
          ...
          <section className="relative">
            ...
            <div className="space-y-6 text-muted-foreground leading-relaxed text-lg max-w-3xl mb-12">
              <p>
                Businesses work with us on a complete end-to-end journey, taking them from a simple
                idea to a fully scalable system. This isn't about quick fixes or disjointed tactics;
                it's a structured, proven approach designed to build a lasting foundation.
              </p>
            </div>
            ...
            <div className="relative pl-8 md:pl-0">
              ...
              {[
                ...
                >
                  ...
                  >
                    <h5 className="text-xl text-white font-display font-medium mb-2">
                      {step.title}
                    </h5>
          ...
          <section className="relative text-center">
            ...
            <p className="text-muted-foreground leading-relaxed text-lg max-w-3xl mx-auto mb-12">
              We use modern, proven technologies because they simply work better. From React and
              Node.js to AWS and AI automation tools, we build on a rock-solid foundation that will
              effortlessly grow with your business.
            </p>
          ...
          <section className="relative">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-6 text-muted-foreground leading-relaxed text-lg">
                  <p>
                    We serve businesses across Pakistan with a deep understanding of the local
                    market. Our operations are anchored by our Head Office in Wah Cantt, an
                    additional office in the bustling Blue Area of Islamabad, and our Chitral
                    location. From these hubs, we actively work with and support companies across
                    major cities including Islamabad, Lahore, and Karachi.
                  </p>
                  <p>
                    We are also expanding rapidly in Saudi Arabia to serve ambitious businesses
                    across the region. With a dedicated regional office focusing on Riyadh, Jeddah,
                    and Dammam, we bring the same level of technical expertise combined with crucial
                    local insight directly to the Saudi market.
                  </p>
                </div>
              </div>
          ...
          <section className="relative py-12">
            ...
            <div className="relative z-10 text-center mb-12">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
                The numbers that truly matter are the ones that affect our clients' bottom lines.
                These represent real growth and tangible business impact.
              </p>
            </div>
          ...
          <section className="relative">
            <div className="text-center mb-16">
              ...
              <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                We know that not all businesses are the same, so support shouldn't be
                one-size-fits-all. We offer three tailored levels of support.
              </p>
            </div>
        ...
        <section className="relative overflow-hidden border-t border-white/10">
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
            ...
            >
              From building a distinctive brand identity to deploying AI-enabled business
              operations, we're here to help your business grow with structure, speed, and
              measurable impact.
            </motion.p>
